<div class="houses index">
	...
	<tr>
		<td><?php echo h($house['House']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($house['Area']['title'], array('controller' => 'areas', 'action' => 'view', $house['Area']['id'])); ?>
		</td>
		<td><?php echo h($house['House']['title']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $house['House']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $house['House']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $house['House']['id']), null, __('Are you sure you want to delete # %s?', $house['House']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
