<div class="consumptions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('lower_no');?></th>
			<th><?php echo $this->Paginator->sort('upper_no');?></th>
	...
	<tr>
		...
		<td><?php echo h($consumption['Consumption']['lower_no']); ?>&nbsp;</td>
		<td><?php echo h($consumption['Consumption']['upper_no']); ?>&nbsp;</td>
		<td class="actions">
