...
--
-- Host: localhost
-- Generation Time: Jul 13, 2014 at 08:58 AM
...
CREATE TABLE IF NOT EXISTS `surveys` (
  ...
  `amount` int(11) NOT NULL DEFAULT '0' COMMENT 'Money amount When keyword is BR',
  `outlet` varchar(40) DEFAULT NULL COMMENT 'When Keyword is BR',
  ...
  `is_br` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'When keyword is BR',
